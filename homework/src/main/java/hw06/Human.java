...
public class Human {
    ...
    public String toStringFormat(String type){
        return String.format("\033[1;30m %s {\033[0m%n name='%s';%n surname='%s';%n year=%d;%n iq=%d;%n schedule=[%s];%n\033[1;30m}\033[0m;", type, name, surname, year, iq, Arrays.toString(schedule));
    }
